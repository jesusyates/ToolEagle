...
用户规则:每聊天交流10次，cursor必须回看记忆本。

用户规则: chatqpt和cursor必须尽自己最大的能力来做这个产品，产品规模越大越好，直到你们两个的技术能力不够，做不了为止。

做出的产品必须好，将来要做成品牌，将来要能赚大钱。

用户什么都不管，只提供资源。只要好的产品。

chatgpt负责统筹一切。cursor负责执行。产品是你们的儿子。必须做好，做完美。

不做小打小闹的产品，不做简单易复制的产品。不做以淘汰的产品。

要做用户需要的产品，市场需要的产品，符合现在和未来趋势的产品，用户喜欢的产品。

你必须分析世界趋势，行情，选择最正确的方向，做出最正确的决定。

chatgpt和cursor必须尽自己最大的能力来做这个产品。
