...
🌍 全球 + 国家双轨 · 🌐 **当前专注 Web（移动优先）→ 中期 PWA → 成熟原生** · 📱 **Mobile-First** · 🧠 分区 AI · 🛡️ **Content Safety Engine = 系统级护城河（全站 AI 输出必过）** · ⚡ 分区性能 · 💰 分区支付 · 🔍 分区 SEO · ♾️ 可扩展 · 🇨🇳 **中国站 = 平台级创作者系统（抖音→小红书→快手，禁 TikTok 直译、禁多平台并行全量）** · **只读本文件**
