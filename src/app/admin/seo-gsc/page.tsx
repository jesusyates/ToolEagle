...
export default async function AdminSeoGscPage() {
  ...
  if (!user) {
    redirect(buildLoginRedirect("/admin/seo-gsc"));
  }
      ...
      <div className="flex-1">
        <section className="container py-12">
          <div className="max-w-2xl">
            <Link href="/admin/seo" className="text-sm font-medium text-sky-600 hover:underline">
              ← SEO Content Center
            </Link>
