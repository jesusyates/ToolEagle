...
/** Last pipeline JSON (same file as legacy `/api/admin/seo-auto-run`). */
...
/**
 * Start one SEO auto-production round (gap pipeline + optional schedule).
 * Body matches `/api/admin/seo-auto-run` POST.
 */
export async function POST(request: Request) {
  ...
  const wantedRaw = body.wanted ?? body.targetCount;
