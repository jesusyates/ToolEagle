...
import { getCachedHookForExamples } from "@/lib/seo/cached-public-examples";
import { robotsForHooksForTopic } from "@/lib/seo/topic-for-page-meta";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const robots = await robotsForHooksForTopic(topic);
  return {
    title,
    description,
    robots,
...
export default async function HooksForPage({ params }: Props) {
  ...
  const displayExamples = await getCachedHookForExamples(topic);
