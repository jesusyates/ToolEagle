          ...
          {sent ? (
            ...
            <>
              <DelegatedButton
                ...
                disabled={loading}
                className="mt-8 w-full flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-60 transition duration-150"
              >
              ...
              <form onSubmit={handleMagicLink} className="mt-4">
                ...
                <DelegatedButton
                  ...
                  disabled={loading}
                  className="mt-3 w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-60 transition duration-150"
                >
