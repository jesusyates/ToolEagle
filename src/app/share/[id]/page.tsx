...
import { ShareWantMoreMoneyBlock } from "@/components/traffic/ShareWantMoreMoneyBlock";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const contentPreview = decoded?.items?.[0]
    ...
    : "";
  const title = tool
    ? `AI-generated ${tool.name} result – Try this tool free`
    : "Shared Result – Try ToolEagle Free";
  const description = contentPreview
    ? `${contentPreview} Generated by ToolEagle. Try this tool for free – no sign-up.`
    : "View AI-generated content. Try ToolEagle – free TikTok captions, YouTube titles, hooks and more.";
