...
import { CreatorAnalysisClient } from "@/components/tools/CreatorAnalysisClient";
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
      ...
      <div className="flex-1">
        ...
        />
        <ToolStructuredData slug={slug} name="Creator Account Analysis" description={metaDescription} />
      </div>
      <SiteFooter />
    </main>
  );
