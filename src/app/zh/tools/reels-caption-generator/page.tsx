...
export const metadata: Metadata = {
  title: "免费 Reels 文案生成器",
  description: "输入主题，一键生成 Instagram Reels 爆款文案。免费无需注册。",
  openGraph: {
    title: "免费 Reels 文案生成器 | ToolEagle",
    description: "输入主题，一键生成爆款文案。免费无需注册。",
    url: `${BASE_URL}/zh/tools/reels-caption-generator`
  }
};

export default async function ZhReelsCaptionGeneratorPage() {
