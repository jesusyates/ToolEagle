...
export const metadata: Metadata = {
  title: "免费 YouTube 标题生成器",
  description: "输入主题，一键生成 YouTube 爆款标题。免费无需注册。",
  openGraph: {
    title: "免费 YouTube 标题生成器 | ToolEagle",
    description: "输入主题，一键生成爆款标题。免费无需注册。",
    url: `${BASE_URL}/zh/tools/youtube-title-generator`
  }
};

export default async function ZhYoutubeTitleGeneratorPage() {
