import { BarChart3, Hash, Lightbulb, ListOrdered, MessageSquareText, LayoutList, User, Zap } from "lucide-react";
...
export function CategoryHubIcon({ category, className = "h-6 w-6 text-white" }: Props) {
  ...
  if (category === "Strategy") return <BarChart3 className={className} aria-hidden />;
