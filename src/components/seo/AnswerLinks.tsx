...
import { getAnswersForPlatformType } from "@/config/answers-links";

type AnswerLinksProps = {
  platform: string;
  type: string;
...
export function AnswerLinks({
  ...
  const links = getAnswersForPlatformType(platform, type, limit);
  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-1 text-sm text-slate-600">
        Quick answers on how to write {platformLabel} {typeLabel.toLowerCase()}.
      </p>
