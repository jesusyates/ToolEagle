/**
 * V66/V80 Author Entity - E-E-A-T + AI Authority signals
 * Person/Organization schema for AI systems
 */
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600 leading-relaxed">
              AI 内容增长专家，5+ 年 AI 内容与社交增长经验。专注 TikTok、YouTube、Instagram 等平台的涨粉、变现与内容策略。
            </p>
          </div>
        </div>
      </section>
