-- Phase 23: Content Memory Layer (V196)
-- Canonical migration for npm/db:migrate: supabase/migrations/0038_v196_content_memory.sql
-- This file kept for manual Supabase SQL Editor runs (same DDL).
